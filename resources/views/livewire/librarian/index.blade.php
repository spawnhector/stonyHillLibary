<div>
    <div>
        <div class="flex h-screen overflow-y-hidden bg-white" x-data="setup()" x-init="">
          <!-- Loading screen -->
            ...
            <div class="flex-shrink-0 p-2 border-t max-h-14">
              ...
              >
                ...
                <span :class="{'lg:hidden': !isSidebarOpen}"> 
                    <div class="py-1">
                        <a class="dropdown-item text-gray-700 flex justify-between w-full px-4 py-2 text-sm leading-5 text-left" href="{{ route('logout') }}"
          ...
          <div class="flex flex-col flex-1 h-full overflow-hidden">
            ...
            <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
              ...
              >
                ...
                <div class="space-y-6 md:space-x-2 md:space-y-0 flex">
                    <x-modal>
                        ...
                        <x-slot name="btn_class">
                            inline-flex items-center justify-center px-4 py-1 space-x-1 bg-gray-200 rounded-md shadow hover:bg-opacity-20
                        </x-slot>
                        <x-slot name="button">
                            Add Member
                        </x-slot>
                        <x-slot name="content">
                            @livewire('librarian.addmember')
                        </x-slot>
                    </x-modal>
                    <x-modal>
                        <x-slot name="modal_class">
                    ...
                    <x-modal>
                        ...
                        <x-slot name="content">
                            @livewire('librarian.rentbook')
                        </x-slot>
                    </x-modal>
                    @if ($viewRent)
                        <span wire:click="viewMember()" class="inline-flex items-center justify-center px-4 py-1 space-x-1 bg-red-500 text-white rounded-md shadow animate-bounce hover:bg-red-600">View Members</span>
                    @else
                        <span wire:click="viewRent()" class="inline-flex items-center justify-center px-4 py-1 space-x-1 bg-red-500 text-white rounded-md shadow animate-bounce hover:bg-red-600">View Rented Books</span>
                    @endif
                </div>
              </div>
                ...
                @if ($this->getBook())
                    @foreach ($this->getBook() as $item)
                        ...
                        <div class="flex items-start justify-between">
                            ...
                            <span class="text-gray-400">Title: {{$item->title}}</span>
              ...
              @if ($viewRent)
                <h3 class="mt-6 text-xl">Rented Books</h3>
                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        ...
                        <table class="min-w-full overflow-x-scroll divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @if ($this->getRentBook())
                                    @foreach ($this->getRentBook() as $item)
                                        <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm text-gray-500">{{$item->book->title}}</div>
                                                </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">{{$item->member->name}}</div>
                                                <div class="text-sm text-gray-500">{{$item->member->email}}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap flex">
                                                {{$this->returnDate($item->return_date)}}
                                            </td>
                                ...
                                @if ($this->getMember())
                                    @foreach ($this->getMember() as $item)
                                        <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                @if ($this->getMemberBook($item->id))
                                                    <div class="text-sm text-gray-500">{{count($this->getMemberBook($item->id))}}</div>
                                                @else
                                                    No Books Rented.
                                                @endif
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap flex">
                                                ...
                                                <x-modal>
                                                    ...
                                                    <x-slot name="btn_class">
                                                        ml-2 inline-flex items-center justify-center px-4 py-1 space-x-1 bg-gray-200 rounded-md shadow hover:bg-opacity-20
                                                    </x-slot>
                                                    <x-slot name="button">
                                                        Delete Member
                                                    </x-slot>
